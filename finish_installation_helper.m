...
static void new_connection_handler(xpc_connection_t peer)
{
    xpc_connection_set_event_handler(peer, ^(xpc_object_t event) {
        ...
        if (type == XPC_TYPE_ERROR) {
            ...
            NSString *relaunchToolPath = [NSString stringWithUTF8String:xpc_array_get_string(array, 0)];
            
            int err = removexattr(relaunchToolPath.UTF8String, "com.apple.quarantine", 0);
            if ( err == -1 ) {
